...
El parche **Precision & Reliability 1.7.1** corrige la mira desde su origen: la dispersión se aplica en los ejes de la cámara y se proyecta según FOV y resolución, conserva feedback de disparo incluso con configuraciones extremas y nunca hereda el arma oculta al usar cuchillo. La simulación subdivide frames lentos para impedir granadas a través de paredes, el cuchillo, las explosiones y el melee zombi respetan cobertura, y el cliente recibe correcciones autoritativas de movimiento. También repara orientación/aparición de bots, inventario tras reconexión, orden de la baja final, protocolo, heartbeat, audio no compatible, polling, ranking y navegación móvil.

El parche **Clean SFX 1.7.2** elimina el falso ambiente producido por efectos repetidos y deja una mezcla cerrada a disparos, granadas, cambio de arma, salto, muerte y respawn. Impactos por bala, hitmarkers sonoros, daño, aterrizajes, recarga, cargador vacío, compras, rachas, cuchilladas y chat quedan en silencio; los tiroteos automáticos entre bots conservan sus efectos visuales sin entrar en la mezcla. Cada fuente restante es one-shot, tiene una parada finita y las voces residuales se cancelan al morir o reaparecer.
...
El parche **Anatomical Operator 1.7.7** reconstruye las extremidades del operador con hombros anclados al torso, brazo y antebrazo proporcionados, codos cubiertos, puños continuos y mangas cónicas redondeadas. Cada mano incorpora tres falanges por dedo, índice de gatillo independiente y la pose real de las siete armas; pistola, revólver, escopeta, subfusil, rifle, francotirador y lanzagranadas ya no heredan un agarre genérico. La vista 3D añade respiración sutil, conserva los hitboxes históricos invisibles y limita sombras en detalles pequeños para mantener estable el rendimiento multijugador.

El parche **Visible Reloads 1.7.8** da a cada arma una recarga completa y reconocible en primera persona. Pistola, subfusil, rifle y francotirador extraen, presentan e insertan su cargador con las balas visibles; la escopeta introduce cada cartucho necesario antes de accionar la bomba; el revólver abre el tambor, usa un speedloader sin duplicar munición y vuelve a cerrarlo; y el lanzagranadas abre la recámara e introduce una granada física. La mano de apoyo acompaña cada pieza sin saltos, conserva hombros y codos anatómicos, mantiene la acción dentro del encuadre a FOV 70–78 y bloquea ADS durante el proceso. Muerte, cambio de arma, cuchillo o pérdida de control cancelan la recarga sin conceder munición ni dejar objetos visibles.

El parche **Fluid Knife Combat 1.7.9** sustituye el golpe rígido del cuchillo por una coreografía completa de preparación, impacto, seguimiento y recuperación. Los ataques alternan corte y estocada, conservan dedos, muñecas, codos y hombros anatómicos, mantienen independiente la mano de guardia y reducen el movimiento de carrera durante el contacto. Los clics rápidos encadenan inmediatamente un ataque adicional sin cooldown perceptible ni acumular golpes automáticos; cada swing aplica como máximo un impacto y cualquier muerte, pérdida de control o cambio de arma cancela el golpe pendiente. Cliente y servidor comparten alcance, altura y cono frontal, el objetivo mejor alineado recibe el ataque y una validación autoritativa inferior al ciclo físico evita paquetes de daño falsificados sin frenar al jugador.
